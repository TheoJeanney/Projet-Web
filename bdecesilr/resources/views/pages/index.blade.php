...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <ol class="carousel-indicators">
        <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li> <!-- The active class permit to set visible the carousel -->
        <li data-target="#carouselExampleIndicators" data-slide-to="1" class=""></li>
        <li data-target="#carouselExampleIndicators" data-slide-to="2" class=""></li>
    </ol>
    <!-- contents of the carousel -->
    <div class="carousel-inner"  >
        <div class="carousel-item active" > <!-- The active class permit to set visible the carousel -->
    ...
    <!--The buttons allows the user to go back and forth between the slides manually. -->
...
<!-- This part shows the sponsors of our BDE -->
<div class="sponsors">
    <h1>Nos Sponsors</h1>
    <ul>
...
<!-- This part shows the youtube video of our BDE -->
<div class="ytvid">
