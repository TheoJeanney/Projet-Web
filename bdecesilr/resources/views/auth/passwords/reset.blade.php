...
<!-- This code permit to made the second part of the reset form. -->
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}"> <!-- the POST method's used to send the password to our database to update the password. -->
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Réinitialiser votre mot de passe') }} <!-- this button permit to run the action -->
                                </button>
                            </div>
                        </div>
                    </form>
